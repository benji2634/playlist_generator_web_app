	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        this.state.artists.filter(function (artist) {
	          ...
	          return React.createElement(Artist, _extends({}, artist, { key: artist.artistid }));
	        })
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Artist = function Artist(props) {
	  return React.createElement(
	    'div',
	    { className: 'artist' },
	    React.createElement('img', { src: 'images/' + props.image, className: 'artist-image' }),
	    React.createElement(
	      'div',
	      ...
	      React.createElement(
	        'a',
	        { className: 'artist-website', href: props.website },
	        '(',
	        props.website,
	        ')'
	      )
